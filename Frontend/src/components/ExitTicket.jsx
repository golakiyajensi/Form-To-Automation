...
export default function JobApplicationFormBuilder() {
  ...
  const [formTitle, setFormTitle] = useState("Exit Ticket");
    ...
    <div className="background1">
      <div className="gform-container">
        ...
        <div className="gform-header-banner">
          <img src="/img/exit ticket.jpg" alt="Header" />
        </div>
        <div className="form-header-bar1"></div>
        {/* Header */}
        ...
        <form className="gform-form" onSubmit={handleSubmit}>
          ...
          {/* Resume */}
          <div className="gform-card border rounded-3">
            <label className="gform-label">What would help make today's lesson more effective?</label>
            <input
              type="text"
              className="gform-input"
              required
