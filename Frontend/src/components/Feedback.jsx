...
export default function JobApplicationFormBuilder() {
  ...
  // Example state
  const [formData, setFormData] = useState({
    positions: ["Comments", "Questions", "Bug Reports", "Feature Request"],
    selected: []
  });
  ...
  return (
    <div className="background2 mt-4" style={{paddingTop:"30px"}}>
      <div className="gform-container">
        {/* Header Banner */}
        <div className="gform-header-banner">
          <img src="/img/feedback.jpg" alt="Header" />
        </div>
            ...
            <div key={index} className="gform-checkbox">
              <label className="mt-2 flex items-center gap-2">
                <input
                  type="checkbox"
                  value={pos}
                  checked={formData.selected.includes(pos)}
        ...
        <form className="gform-form" onSubmit={handleSubmit}>
          <div className="gform-card border rounded-3">
            <label className="gform-label">
              Feedback <span className="gform-required">*</span>
            </label>
          ...
          {/* Resume */}
          <div className="gform-card border rounded-3">
            <label className="gform-label">Email</label>
            <input
              type="email"
              className="gform-input"
              required
