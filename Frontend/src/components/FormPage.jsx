...
const ContactForm = () => {
  ...
  return (
    <>
      <div className="background001" style={{backgroundColor:"#e9fae1", padding:"20px 0 20px"}}>
        <div className=" gform-container">
          <div className="form-header" style={{ maxWidth: "870px" }}></div>
          ...
          <div
            ref={blockRef}
            className={`question-block ${isExpanded ? "expanded" : ""}`}
            onClick={() => setIsExpanded(true)}
          >
            <div className="question-title-row flex-wrap">
              <div
              ...
              <div className="question-type flex-wrap">
          ...
          <div
            ref={emailBlockRef}
            className={`question-block ${isEmailExpanded ? "expanded" : ""}`}
          ...
          >
            ...
            <div className="question-preview">
              {renderFieldByType(emailType, true)}
            </div>
