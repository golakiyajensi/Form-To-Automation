        ...
        <div className="rsvp-main-container">
          ...
          <div className="rsvp-question-card">
            ...
            >
              ...
              {expandedQuestion && (
                ...
                >
                  <FaImage className="rsvp-icon" onClick={handleFileClick} />
                  <input
                    type="file"
                    accept="image/*"
                    style={{ display: "none" }}
            ...
            {expandedQuestion && (
              <>
                ...
                {selectedFile && (
                  <p className="rsvp-file-name">Uploaded: {selectedFile}</p>
                )}
              </>
            )}
            ...
            <div className="rsvp-options">
              {questionType === "Multiple choice" && (
                <>
                  <label>
                    <input type="radio" name="attendance" /> Yes, I'll be there
                  </label>
                  <label>
                    <input type="radio" name="attendance" /> Sorry, can't make
                    it
                  </label>
                </>
              )}
          ...
          <div className="event-mcq-card">
            ...
            <div className="event-mcq-options">
              <label className="event-mcq-option">
                <input type="radio" name="eventSource" value="Website" />{" "}
                Website
              </label>
              <label className="event-mcq-option">
              ...
              <label className="event-mcq-option">
                <input type="radio" name="eventSource" value="Newsletter" />{" "}
                Newsletter
              </label>
              <label className="event-mcq-option">
                <input type="radio" name="eventSource" value="Advertisement" />{" "}
                Advertisement
              </label>
            </div>
          </div>
          ...
          {dynamicFields.map((field, index) => (
            <div key={index} className="dynamic-field">
              ...
              {field.type === "section" && (
                <div className="event-mcq-card">
                  <label className="event-mcq-label">New Section</label>
