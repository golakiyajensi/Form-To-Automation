...
export default function EditMeditaionInterests() {
        ...
        const fetchData = async () => {
            try {
                ...
                if (!itemToEdit) {
                    ...
                    navigate('/admin/dashboard/wellbeing');
                    return;
                }
                ...
                toast.error("Failed to load wellbeing item");
                navigate('/admin/dashboard/wellbeing');
            } finally {
    ...
    const res = await axiosInstance.put(
        `${API_URL}/api/meditation-interest/${item.id}`,
        updateData
    );
    console.log("Update response:", res.data);

    if (res.data.status === true) { // <-- Corrected check
        toast.success(res.data.message || "meditation-interests item updated successfully");
        navigate('/admin/dashboard/meditation-interests');
    } else {
        ...
        return (
            <div className="p-6 max-w-4xl mx-auto">
                <div className="text-center py-8">
                    ...
                    <p className="mt-2">Loading meditation-interests item...</p>
                </div>
            </div>
        );
    }
    ...
    if (!item) {
        return (
            <div className="p-6 max-w-4xl mx-auto">
                <div className="text-center py-8">
                    <p className="text-red-500">meditation-interests item not found</p>
                    <button 
                        onClick={handleBack}
                ...
                <div className=" p-5 rounded-t-lg  border-b">
                    <div className="md:flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl md:text-2xl font-bold">Edit meditation-interests Item</h1>
                        </div>
