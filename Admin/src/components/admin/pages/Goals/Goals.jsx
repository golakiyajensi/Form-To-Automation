...
const Goals = () => {
    ...
    const [goalmasterItems, setgoalmasterItems] = useState([]);
    ...
    const fetchData = async () => {
        ...
        setError(null);
        try {
            const response = await apiRequest(`${API_URL}/api/goal-masters/admin/all`);
            const items = Array.isArray(response.data) ? response.data : [];
            setgoalmasterItems(items);
        } catch (err) {
    ...
    const filteredItems = goalmasterItems.filter((item) => {
        const matchesSearch =
    ...
    const handleEdit = (item) => {
        navigate(`/admin/dashboard/goals/edit/${item.id}`);
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await apiRequest(
                `${API_URL}/api/goal-masters/${selectedItem.id}`,
                {
                    method: "DELETE",
                }
            );
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
                            <h1 className="text-xl sm:text-2xl font-bold text-gray-700">GOALS</h1>
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    >
                                        ...
                                        <span className="hidden sm:inline">Add Goals</span>
                                        ...
                                        <div className="lg:hidden p-4">
                                            ...
                                            {currentItems.map((item) => (
                                                <MobileCard key={item.id} item={item}
                                                    index={startIndex + currentItems.indexOf(item)}
                                                />
                                            ))}
                                        </div>
