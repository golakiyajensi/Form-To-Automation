...
const Emotions = () => {
    ...
    const [formData, setFormData] = useState({ title: "", statusFlag: 1, icon: "" });
    ...
    const fetchData = async () => {
        ...
        setError(null);
        try {
            const response = await apiRequest(`${API_URL}/api/emotion-masters/admin/all`);
    ...
    const closeModal = () => {
        ...
        setFormData({ title: "", statusFlag: 1, icon: "" });
    };
    ...
    const handleEdit = (item) => {
        navigate(`/admin/dashboard/emotions/edit/${item.id}`);
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await apiRequest(
                `${API_URL}/api/emotion-masters/${selectedItem.id}`,
                {
                    method: "DELETE",
                }
            );
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
                            <h1 className="text-xl sm:text-2xl font-bold text-gray-700">EMOTIONS</h1>
                        ...
                        <div className="p-4 sm:p-6 border-b border-gray-200">
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <Link
                                        to="/admin/dashboard/emotions/add"
                        ...
                        {!loading && !error && (
                            <>
                                {filteredItems.length === 0 ? (
                                    <div className="text-center py-12">
                                        <p className="text-gray-500">No emotions found</p>
                                    </div>
                                ) : (
                                    <>
                                        {/* Desktop Table View */}
